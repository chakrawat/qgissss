...
lyr_amphoe_1.set('fieldLabels', {'ID': 'header label - visible with data', 'AMP_CODE': 'header label - visible with data', 'AMP_TH': 'hidden field', 'AMP_EN': 'no label', 'PROV_CODE': 'no label', 'PROV_TH': 'no label', 'PROV_EN': 'no label', 'REG_NESDB': 'no label', 'REG_ROYIN': 'no label', 'AREA': 'no label', 'ADMIN_TYPE': 'no label', });
lyr_village_2.set('fieldLabels', {'NRD_CODE': 'no label', 'VILL_CODE': 'no label', 'VILL_NAM_T': 'hidden field', 'PROV_CODE': 'no label', });
lyr_water_way_3.set('fieldLabels', {'osm_id': 'no label', 'code': 'no label', 'fclass': 'header label - visible with data', 'width': 'no label', 'name': 'inline label - always visible', });
